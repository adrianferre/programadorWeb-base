...
- Pedir al usuario mediante `prompt` que ingrese su género y luego su edad. Luego mostrar un mensaje en consola que diga `Sr.`, `Sra.` o `Sx.`según corresponda y que también evalúe si es mayor de edad o no al momento de construir el mensaje.
